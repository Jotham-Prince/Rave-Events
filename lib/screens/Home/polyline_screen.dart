...
import 'package:rave_events/models/polyline_response.dart';
...
class _PolylineScreenState extends State<PolylineScreen> {
  static const CameraPosition initialPosition =
      CameraPosition(target: LatLng(1.3733, 32.2903), zoom: 14);
  ...
  String apiKey = "AIzaSyCDCSP4KOSNBoCNQQYcQnxsAsAkLCmY9jo";

  LatLng origin = const LatLng(0.3476, 32.5825);
  LatLng destination = const LatLng(0.0512, 32.4637);
